...
<body>
    ...
    <section class="navbar ">
        <div class="nav-container">
            <div class="logo">
             <a href="index.php">   <img src="images/facebook_cover_photo_1.png" width=100% class="img-responsive"></a>
                <!-- logo -->
            ...
            <div class="navbar-links">
                <ul>
                    ...
                    <li>
                        <a href="login.php"> <a href="cart_manage.php"><i class="bi bi-cart-fill"></i>
                    ...
                    &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 
                    <li>
                    <a href="order.php"><i class="bi bi-truck"></i> 
        ...
        <div class="nav">
            <div class="subnav-links">
                <ul>
                    ...
                    <li>
                        <a href="special_occasion.php"> Special Occasion</a>
                    </li>
